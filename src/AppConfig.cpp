...
const char* FIRMWARE_VERSION = "1.25.1-sd-page-stability";
const char* FIRMWARE_CHANGE_TITLE = "v1.25.1 estabilitat pàgina SD";
const char* FIRMWARE_CHANGE_NOTES = "Redueix les previsualitzacions pesades de logs i blackbox a la pàgina de microSD per evitar pressió de memòria i reinicis PANIC quan es consulta l'històric.";
