...
const char* FIRMWARE_VERSION = "1.25.4-web-page-size-fix";
const char* FIRMWARE_CHANGE_TITLE = "v1.25.4 pàgines web completes";
const char* FIRMWARE_CHANGE_NOTES = "Redueix el JavaScript global de l'OTA, envia les pàgines HTML grans en fragments i evita que SD, Sistema, Manteniment i Ajuda quedin tallades a 64 KB.";
