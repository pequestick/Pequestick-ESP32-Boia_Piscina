...
const char* FIRMWARE_VERSION = "1.25.5-help-page-slim";
const char* FIRMWARE_CHANGE_TITLE = "v1.25.5 ajuda sense tallar";
const char* FIRMWARE_CHANGE_NOTES = "Renderitza només la subsecció d'Ajuda oberta perquè Changelog, fitxers, MQTT, hardware i rescat no superin el límit pràctic de memòria del HTML.";
