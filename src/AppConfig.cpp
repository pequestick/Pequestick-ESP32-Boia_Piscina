...
const char* FIRMWARE_VERSION = "1.25.9-chart-hover-scoped";
const char* FIRMWARE_CHANGE_TITLE = "v1.25.9 gràfic optimitzat";
const char* FIRMWARE_CHANGE_NOTES = "Manté el tooltip i el mini gràfic de bateria a la pàgina principal, però mou el codi específic fora de les pàgines grans perquè OTA no quedi tallada.";
