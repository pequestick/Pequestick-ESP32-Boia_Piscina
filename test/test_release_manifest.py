...
class ReleaseManifestTests(unittest.TestCase):
    ...
    def test_mpu6050_motion_sensor_is_wired_to_status_mqtt_and_ha(self):
        ...
        self.assertIn("configMotionReadIntervalSeconds", config)
        self.assertIn("saveMotionZeroConfig", config)
        self.assertIn("lastMotionPitchDeg", state)
        self.assertIn("lastMotionAccelDeltaG", state)
        self.assertIn("motionSplashAlarm", state)
        ...
        self.assertIn("calibrateMotionZeroFromCurrent", sensor)
        ...
        self.assertIn("motion_summary", web)
        self.assertIn("motion_accel_delta_g", web)
        self.assertIn("motion_profile", web)
        self.assertIn("motion-config", web)
        self.assertIn("motion-zero", web)
        ...
        self.assertIn('discoveryTopic("sensor", "motion_accel_delta_g")', mqtt)
        self.assertIn('discoveryTopic("binary_sensor", "motion_tilt_alarm")', mqtt)
        self.assertIn('discoveryTopic("binary_sensor", "motion_splash_alarm")', mqtt)
    ...
    def test_home_assistant_statistics_cover_all_history_ranges_and_sensors(self):
        ...
        self.assertIn("battery-mini-chart", web)
        self.assertIn("bindChartHover", web)
        self.assertIn("syncCompanionChart", web)
        self.assertIn("previous_battery_voltage", web)
